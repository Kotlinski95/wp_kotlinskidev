...
├── functions/                                  # 43 PHP modules, require_once'd from functions.php (cache.php must load first)
...
│   ├── blocks/                                 # 44 custom block dirs: 31 registered blocks + 13 JS-only block-extension filters
...
│   │   ├── theme-colors.scss                   # editor-styles-wrapper color/gradient-text mixins
