    ...
    <div class="wp-block-columns are-vertically-aligned-center" style="margin-top:0;margin-bottom:0"><!-- wp:column {"verticalAlignment":"center","width":"40%"} -->
        ...
        <div class="wp-block-column is-vertically-aligned-center"><!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"left"}} -->
            ...
            <div class="wp-block-group" style="margin-top:40px"><!-- wp:heading {"level":4,"style":{"elements":{"link":{"color":{"text":"var:preset|color|foreground-alt"}}}},"textColor":"foreground-alt","fontSize":"medium"} -->
                ...
                <p class="has-meta-color-color has-text-color has-link-color"><?php esc_html_e('Enable businesses to streamline their processes, reduce costs, and enhance productivity with seamless and effective SaaS applications.', 'kotlinskidev') ?></p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->

            <!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|30"}},"layout":{"type":"constrained"}} -->
            <div class="wp-block-group"><!-- wp:heading {"level":4,"style":{"elements":{"link":{"color":{"text":"var:preset|color|foreground-alt"}}}},"textColor":"foreground-alt","fontSize":"medium"} -->
                <h4 class="wp-block-heading has-foreground-alt-color has-text-color has-link-color has-medium-font-size"><?php esc_html_e('Global Reach and Accessibility', 'kotlinskidev') ?></h4>
                <!-- /wp:heading -->

                <!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|meta-color"}}}},"textColor":"meta-color"} -->
                <p class="has-meta-color-color has-text-color has-link-color"><?php esc_html_e('Expand our reach by making SaaS solutions accessible, affordable, and adaptable for diverse industries and businesses worldwide.', 'kotlinskidev') ?></p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
