...
?>
<!-- wp:group {"metadata":{"categories":["kotlinskidev"],"patternName":"kotlinskidev/about-us","name":"About Us Section"},"style":{"spacing":{"padding":{"top":"7.5rem","bottom":"7.5rem","left":"var:preset|spacing|40","right":"var:preset|spacing|40"},"margin":{"top":"0","bottom":"0"}}},"backgroundColor":"background-alt","layout":{"type":"constrained","contentSize":"73.75rem"}} -->
<div class="wp-block-group has-background-alt-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:7.5rem;padding-right:var(--wp--preset--spacing--40);padding-bottom:7.5rem;padding-left:var(--wp--preset--spacing--40)"><!-- wp:columns {"verticalAlignment":"center","style":{"spacing":{"blockGap":{"left":"3rem"},"margin":{"top":"0","bottom":"0"}}}} -->
    <div class="wp-block-columns are-vertically-aligned-center" style="margin-top:0;margin-bottom:0"><!-- wp:column {"verticalAlignment":"center"} -->
        ...
        <div class="wp-block-column is-vertically-aligned-center"><!-- wp:image {"id":5979,"sizeSlug":"full","linkDestination":"none","align":"right","style":{"border":{"radius":"0rem"},"color":{"duotone":"var:preset|duotone|secondary-light"}}} -->
            <figure class="wp-block-image alignright size-full has-custom-border"><img src="<?php echo esc_url($kotlinskidev_images[0]) ?>" alt="" class="wp-image-5979" style="border-radius:0rem" /></figure>
            <!-- /wp:image -->
        </div>
        <!-- /wp:column -->
    </div>
