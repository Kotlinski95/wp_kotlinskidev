...
if (is_single() && get_post_type() === 'post') {
    ...
    if (!empty($categories)) {
        ...
        $breadcrumbs[] = '<a href="' . esc_url(get_category_link($category->term_id)) . '" style="color:var(--wp--preset--color--primary);text-decoration:none;">' . esc_html($category->name) . '</a>';
    }
...
<!-- wp:group {"style":{"spacing":{"margin":{"bottom":"30px"}}},"layout":{"type":"constrained","contentSize":"800px"}} -->
