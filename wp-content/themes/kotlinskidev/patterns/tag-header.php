...
$breadcrumbs[] = '<span style="color:var(--wp--preset--color--foreground-alt);">Tag: ' . esc_html($tag_name) . '</span>';
?>
...
<div class="wp-block-group" style="margin-bottom:60px">
    ...
    <div style="text-align:center;">
        <div style="display:inline-block;padding:8px 16px;background:var(--wp--preset--color--primary);color:white;border-radius:20px;font-size:14px;font-weight:600;margin-bottom:20px;">
            #<?php echo esc_html($tag_name); ?>
        </div>
        
        <h1 style="color:var(--wp--preset--color--foreground-alt);font-weight:800;font-size:2.5rem;margin-bottom:15px;">
            Articles tagged with "<?php echo esc_html($tag_name); ?>"
        </h1>
        ...
        <div style="display:flex;justify-content:center;align-items:center;gap:20px;margin-bottom:30px;">
            ...
            <a href="<?php echo esc_url($breadcrumb_settings['topics_url']); ?>" style="color:var(--wp--preset--color--primary);text-decoration:none;">
                ← Browse All Topics
            </a>
        </div>
    </div>
