      ...
      <div>
        <InspectorControls>
          <PanelBody title={__("Form Settings", "kotlinskidev")}>
            <TextControl label={__("Name Label", "kotlinskidev")} value={attributes.nameLabel} onChange={(value) => setAttributes({ nameLabel: value })} />
            <TextControl label={__("Name Placeholder", "kotlinskidev")} value={attributes.namePlaceholder} onChange={(value) => setAttributes({ namePlaceholder: value })} />
            <TextControl label={__("Email Label", "kotlinskidev")} value={attributes.emailLabel} onChange={(value) => setAttributes({ emailLabel: value })} />
            <TextControl label={__("Email Placeholder", "kotlinskidev")} value={attributes.emailPlaceholder} onChange={(value) => setAttributes({ emailPlaceholder: value })} />
            <TextControl label={__("Topic Label", "kotlinskidev")} value={attributes.topicLabel} onChange={(value) => setAttributes({ topicLabel: value })} />
            <TextControl label={__("Topic Placeholder", "kotlinskidev")} value={attributes.topicPlaceholder} onChange={(value) => setAttributes({ topicPlaceholder: value })} />
            <TextControl label={__("Message Label", "kotlinskidev")} value={attributes.messageLabel} onChange={(value) => setAttributes({ messageLabel: value })} />
            <TextareaControl label={__("Message Placeholder", "kotlinskidev")} value={attributes.messagePlaceholder} onChange={(value) => setAttributes({ messagePlaceholder: value })} />
            <TextControl label={__("Agree Checkbox Label", "kotlinskidev")} value={attributes.agreeLabel} onChange={(value) => setAttributes({ agreeLabel: value })} />
            <TextControl label={__("Submit Button Label", "kotlinskidev")} value={attributes.submitLabel} onChange={(value) => setAttributes({ submitLabel: value })} />
            <TextControl label={__("Success Message", "kotlinskidev")} value={attributes.successMessage} onChange={(value) => setAttributes({ successMessage: value })} />
            <TextControl label={__("Error Message", "kotlinskidev")} value={attributes.errorMessage} onChange={(value) => setAttributes({ errorMessage: value })} />
          </PanelBody>
            ...
            {attributes.enableCaptcha && (
              <>
                <SelectControl
                  ...
                  onChange={(value) => setAttributes({ captchaProvider: value as ContactFormAttributes["captchaProvider"] })}
                ...
                {attributes.captchaProvider === "recaptcha" && (
                  <>
                    ...
                    <TextControl
                      ...
                      help={__("Keep this secret! Used for server-side verification.", "kotlinskidev")}
                      placeholder="6Lc..."
                      type="password"
                    />
                  </>
          ...
          <PanelBody title={__("Redirect Settings", "kotlinskidev")} initialOpen={false}>
            <SelectControl
              ...
              options={[
                { label: __("Show success message on same page", "kotlinskidev"), value: "query_param" },
                { label: __("Redirect to thank you page", "kotlinskidev"), value: "thank_you_page" },
              ]}
              onChange={(value) => setAttributes({ redirectType: value as ContactFormAttributes["redirectType"] })}
            ...
            {attributes.redirectType === "thank_you_page" && (
              <TextControl
                ...
                help={__("Enter the full URL of your thank you page. Leave empty to use WordPress default.", "kotlinskidev")}
        ...
        <form {...blockProps}>
          <label>
            ...
            <input type="text" placeholder={attributes.namePlaceholder} disabled />
          </label>
          <label>
            {attributes.emailLabel}
            <input type="email" placeholder={attributes.emailPlaceholder} disabled />
          </label>
          <label>
            {attributes.topicLabel}
            <input type="text" placeholder={attributes.topicPlaceholder} disabled />
          </label>
          <label>
