...
const withCounterAnimationControls = createHigherOrderComponent((BlockEdit) => {
  return (props: any) => {
    ...
    const { enableCounter, counterDuration, counterCustomDuration, counterEasing } = attributes;
        ...
        <InspectorControls>
          ...
          >
            <ToggleControl
              ...
              help={__(
                "Turn this block into an animated counter. Numbers in your text will automatically count up from 0 when the block comes into view.",
                "kotlinskidev"
              )}
            />
            ...
            {enableCounter && (
              <Fragment>
                ...
                >
                  ...
                  >
                    {__(
                      'Just type your text with numbers like "5 years", "98%", or "$1,250". The system will automatically detect the numbers and animate them from 0 to the detected value.',
                      "kotlinskidev"
                    )}
                  </p>
                </div>
...
function applyCounterAnimationClass(extraProps: any, blockType: any, attributes: any) {
  ...
  if (enableCounter) {
    ...
    extraProps["data-counter-duration"] =
      counterDuration === "custom" ? counterCustomDuration || 2000 : counterDuration || 2000;
