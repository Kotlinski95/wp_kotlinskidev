...
if ( ! isset($_COOKIE['maintenance_mode']) || $_COOKIE['maintenance_mode'] !== 'enabled' ) {
    // Allow access if maintenance mode is not enabled
    return;
}
...
if ( ! $maintenance_mode || current_user_can('edit_themes') ) {
    // Allow access for logged-in users who can edit themes
    return;
}
?>
<!DOCTYPE html>
